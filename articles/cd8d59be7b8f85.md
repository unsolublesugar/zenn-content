...
:::message alert
本記事は **2026年2月時点** の検証内容をもとに執筆しています。その後のツールのアップデートにより、仕様が変更されています。**Unity CLI Loop**変更後の導入手順は[こちら](https://zenn.dev/unsoluble_sugar/articles/bf666326e854d1)をご参照ください。
:::
